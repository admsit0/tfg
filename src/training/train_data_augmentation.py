...
def train_network(net, train_loader, nepochs=EPOCHS, lr=0.001):
...
# --- RUN ---
print(f"\n>>> RUN DATA AUGMENTATION: Reduced Dataset (25k, ConvNet)")
indices = torch.randperm(len(tensor_x_train))[:25000]
